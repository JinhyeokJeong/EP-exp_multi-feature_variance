...
function drawTexture_colBars_corr(oriMean, hueMean, oriRan, hueRan, corrcond, coord, ctx){
    ...
    [ori_angles, hue_angles] = randPerms_joint(ori_angles, hue_angles);    
    ...
    return {ori_angles: ori_angles, hue_angles: hue_angles, correlation: corrcond, flag_corr:flag_corr}
}